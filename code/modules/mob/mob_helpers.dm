...
proc/slur(phrase)
	...
	for(var/i = 1; i <= lentext(phrase); i++)
		...
		if(letter == "ί")
			...
			continue
		if(prob(33))
			if(lowerrustext(letter)=="ξ")	letter="σ"
			if(lowerrustext(letter)=="ϋ")	letter="i"
			if(lowerrustext(letter)=="π")	letter="r"
			if(lowerrustext(letter)=="λ")	letter="λό"
			if(lowerrustext(letter)=="η")	letter="ρ"
			if(lowerrustext(letter)=="β")	letter="τ"
			if(lowerrustext(letter)=="α")	letter="ο"
			if(lowerrustext(letter)=="γ")	letter="υ"
			if(lowerrustext(letter)=="δ")	letter="ς"
			//eng
