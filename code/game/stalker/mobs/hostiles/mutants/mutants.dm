...
/mob/living/simple_animal/hostile/mutant/dog
	...
	eng_desc = "This dog became blind because of the radiation, allowing him to develop a more precise sense of smell. His tail is edible and so taking it would be a good idea to make a soup or sell it."
	turns_per_move = 5
	speed = 1
	a_intent = "harm"
	harm_intent_damage = 5
